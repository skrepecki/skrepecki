...
function return_one_link(i, title){
    if(title == '') return `<div class="col-lg-3 col-md-3 col-sm-6 col-6"><a href="/image-`+i+`" class="tm-text-gray d-block mb-2">`+i+`</a></div>`
    return `<div class="col-lg-3 col-md-3 col-sm-6 col-6"><a href="/image-`+i+`" class="tm-text-gray d-block mb-2">`+title+`</a></div>`
}