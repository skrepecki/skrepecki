...
for(let i = 0; i < semen_personal_images.length; i++){
    result_div_personal_images += '<div class="col-md-4 col-12"><img src="https://diseno-web-cantabria.github.io/skrepeckiy.web.app/public/wordpress/img/'+semen_personal_images[i]+'" alt="Роберт Бурдай - Семен Скрепецкий - Скрепоносный Бузотер" class="img-fluid"></div>'
}
