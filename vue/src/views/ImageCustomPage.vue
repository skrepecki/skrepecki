        ...
        <div class="container-fluid tm-container-content tm-mt-10" id="custom_image_page_scroll"><br>
                ...
                <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12"> 
                    <div class="tm-bg-gray tm-video-details">
                        ...
                        <div class="text-center mb-5">
                            <a v-bind:href="'https://diseno-web-cantabria.github.io/skrepeckiy.web.app/public/wordpress/skrep-img/'+currentImageObj.image" class="btn btn-primary tm-btn-big" id="download_link" download="photo_2022-09-26_16-37-03.jpg">Скачать</a>
                        </div>                    
                    </div>
                </div>
            </div>    
            ...
            <div class="row tm-mb-90 tm-gallery">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5" v-for="(item, index) in array_rand_id" v-bind:key="index">
                    <figure class="effect-ming tm-video-item">
                        <img v-bind:src="'https://diseno-web-cantabria.github.io/skrepeckiy.web.app/public/wordpress/skrep-img/'+__SKREP__STORAGE[item].image" v-bind:alt="__SKREP__STORAGE[item].title + ' ' + __SKREP__STORAGE[item].description + ' Семен Скрепецкий Картины'" class="img-fluid index_page_list_image">
            ...
            <div class="row mb-3 tm-gallery" id="custom_image_child_items">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                    <figure class="effect-ming tm-video-item">
                        <img src="https://diseno-web-cantabria.github.io/skrepeckiy.web.app/public/wordpress/skrep-img/0186.jpg" alt="присяга семен скрепецкий" class="img-fluid index_page_list_image">
                        <figcaption class="d-flex align-items-center justify-content-center">
                            <h2>присяга</h2>
